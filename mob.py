...
class Mob:  # Class used for the player and enemies
        ...
        if self.health <= 0:  # start dying if not enough health
            ...
            if self.frame % 25 == 0:  # wait until enemy death animation is done
                if random.randint(0, 2) == 0:  # spawn a drop
                    ...
                    pickupList.append(pickup.Pickup(self.X + self.W // 2,
                            ...
                            if self.shootCounter % weaponList[self.weapon].firerate == 0:
                                ...
                                if self.enemyType == 0:
                                    if self.fA:
                                        ...
                                        bulletList.append(
                                            bullet2.Bullet2(self.X + self.W, self.Y + 25+random.randint(-1,1), 180,
                                                    weaponList[self.weapon].damage // 2, 0, 400, 3,
                                    ...
                                    if self.fA:
                                        bulletList.append(
                                            bullet2.Bullet2(self.X + self.W // 2, self.Y+random.randint(-1,1), 0,
                                                    weaponList[self.weapon].damage // 2, 0, 400, 3,
                                                    weaponList[self.weapon].bulletColour, (255, 0, 0), 5,
                                                    0, 0, 4))
                                    else:
                                        bulletList.append(
                                            bullet2.Bullet2(self.X + self.W // 2, self.Y, 180,
                                                    weaponList[self.weapon].damage // 2, 0, 400, 3,
                                                    weaponList[self.weapon].bulletColour, (255, 0, 0), 5,
                                                    0, 0, 4))
                                    ...
                                    if self.fA:
                                        bulletList.append(
                                            bullet2.Bullet2(self.X + self.W // 2, self.Y + 25+random.randint(-1,1), 0,
                                                    weaponList[self.weapon].damage // 2, 0, 400, 7,
                                                    weaponList[self.weapon].bulletColour, (255, 0, 0), 5,
                                                    0, 0, 4))
                                    else:
                                        bulletList.append(
                                            bullet2.Bullet2(self.X + self.W // 2, self.Y + 25+random.randint(-1,1), 180,
                                                    weaponList[self.weapon].damage // 2, 0, 400, 7,
                                                    weaponList[self.weapon].bulletColour, (255, 0, 0), 5,
                                                    0, 0, 4))
                                    ...
                                    if self.fA:
                                        ...
                                        bulletList.append(
                                            bullet2.Bullet2(self.X + self.W, self.Y + 22+random.randint(-1,1), 180,
                                                    weaponList[self.weapon].damage // 2, 0, 400, 3,
                                                    weaponList[self.weapon].bulletColour, (255, 0, 0), 7,
                                                    0, 0, 2))
    ...
    def damage(self, amount, damagePopoff, dtype=0):
        self.health -= amount
        damagePopoff.append(
            damage_text.DamageText(self.X + (self.W // 2) + random.randint(-30, 30), self.Y + random.randint(-10, 0), amount,
                       dtype))
